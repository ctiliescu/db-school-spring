...
import com.db.shopify.auth.AuthService;
...
//        }
    ...
    @GetMapping("/auth")
    public Customer getCustomersByName(@CookieValue(name = "token") String authToken) throws AuthException {
        final int id1 = authService.getAuthClient(authToken);
        return customerService.getCustomer(id1).get();
    }
